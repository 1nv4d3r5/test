<?php $pagenum="index"; require_once "./admin/runtime.php"; ?>
...
<meta name='description' content="smart academy,center of excellence
" />
...
<div id="wrapper">
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content"><?php content("index"); ?><div style="clear: both;">&nbsp;</div>
				</div>
				<!-- end #content -->
				<div id="sidebar">
					<ul>
