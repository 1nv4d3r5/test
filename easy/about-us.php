<?php $pagenum="about-us"; require_once "./admin/runtime.php"; ?>
...
<meta name='description' content="about the school" />
...
<div id="wrapper">
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content"><?php content("about-us"); ?><div style="clear: both;">&nbsp;</div>
				</div>
				<!-- end #content -->
				<div id="sidebar">
					<ul>
